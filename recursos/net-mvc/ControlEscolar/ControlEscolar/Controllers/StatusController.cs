...
namespace ControlEscolar.Controllers
{
    ...
    public class StatusController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewData["catalogoStatus"] = catalogoStatus;
        ...
        public ActionResult Add(Status status)
        {
            try
            {
                ...
                var payload = JsonConvert.SerializeObject(status,jsonSettings);
                ...
                using (var client = new HttpClient())
                {
                    ...
                    //http://url-api:puerto/pais
                    var responseTask = client.PostAsync("Status/",payloadContent);
                    responseTask.Wait();
                    ...
                    {
                        var content = result.Content.ReadAsStringAsync();
                        status = JsonConvert.DeserializeObject<Status>(content.Result, jsonSettings);
        ...
        public ActionResult Edit(Status status)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    //http://url-api:puerto/pais
                    var responseTask = client.PutAsync("Status/"+status.ID, payloadContent);
                    responseTask.Wait();
        ...
        public ActionResult Delete(Status status)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    //http://url-api:puerto/pais
                    var responseTask = client.DeleteAsync("Status/" + status.ID);
                    responseTask.Wait();
